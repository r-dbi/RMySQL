...
connection_create <- function(host, user, password, db, port, unix_socket, client_flag, groups, default_file, ssl_ca) {
    .Call('RMySQL_connection_create', PACKAGE = 'RMySQL', host, user, password, db, port, unix_socket, client_flag, groups, default_file, ssl_ca)
}
