...
connection_create <- function(host, user, password, db, port, unix_socket, client_flag, groups, default_file, ssl, ssl_key, ssl_cert, ssl_ca, ssl_capath, ssl_cipher) {
    .Call('RMySQL_connection_create', PACKAGE = 'RMySQL', host, user, password, db, port, unix_socket, client_flag, groups, default_file, ssl, ssl_key, ssl_cert, ssl_ca, ssl_capath, ssl_cipher)
}
