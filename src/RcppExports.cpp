...
// connection_create
XPtr<MyConnectionPtr> connection_create(const Rcpp::Nullable<std::string>& host, const Rcpp::Nullable<std::string>& user, const Rcpp::Nullable<std::string>& password, const Rcpp::Nullable<std::string>& db, const unsigned int& port, const Rcpp::Nullable<std::string>& unix_socket, const unsigned long& client_flag, const Rcpp::Nullable<std::string>& groups, const Rcpp::Nullable<std::string>& default_file);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const unsigned int& >::type port(portSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<std::string>& >::type unix_socket(unix_socketSEXP);
    Rcpp::traits::input_parameter< const unsigned long& >::type client_flag(client_flagSEXP);
